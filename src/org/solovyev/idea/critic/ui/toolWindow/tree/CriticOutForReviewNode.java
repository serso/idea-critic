...
public class CriticOutForReviewNode extends SimpleNode {
	private static final String NAME = "Out For Review";
	private final CriticReviewModel myReviewModel;

	public CriticOutForReviewNode(@NotNull final CriticReviewModel reviewModel) {
	...
	public void handleSelection(SimpleTree tree) {
		...
		myReviewModel.updateModel(CriticFilter.OutForReview);
	}
}
