...
public class CriticRequireApprovalNode extends SimpleNode {
	private static final String NAME = "Require My Approval";
	private final CriticReviewModel myReviewModel;

	public CriticRequireApprovalNode(@NotNull final CriticReviewModel reviewModel) {
	...
	public void handleSelection(SimpleTree tree) {
		...
		myReviewModel.updateModel(CriticFilter.RequireApprovalReview);
	}
}
