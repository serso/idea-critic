...
class CommentNodeRenderer extends JBDefaultTreeCellRenderer {
	...
	@NotNull
	private final DefaultTreeCellRenderer myDefaultRenderer = new DefaultTreeCellRenderer();
	@NotNull
	private final CommentRendererPanel myPanel;
	...
	public static class CommentRendererPanel extends JPanel {
		...
		@NotNull
		private final LinkLabel myPostLink;
